...
<div class="container-fluid">
  <div class="row">
    ...
    <a href="addspe.php"><button type="button" class="btn btn-success">Ajouter une nouvelle spécialité</button></a>

  </div></div></div><br>
<div class="container-fluid">
    <div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading">La liste des specialite</div>
       ...
       <?php
        ...
        if ($result->num_rows > 0) {
           ...
           while($row = $result->fetch_assoc()) {
             echo "<tr><td>".$row["id_specialite"]."</td><td>".$row["name_spe"]."</td><td> ".$row["departement"]."</td><td>".$row["detail"]." </td><td> ";
             echo '<a href="editspe.php"><button type="button" class="btn btn-warning">Modifier</button></a></td></tr>';
