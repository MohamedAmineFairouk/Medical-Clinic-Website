...
<head>
    ...
    <body>
      <form class="form-horizontal" method="POST" action="addspe2.php" >
<fieldset>

<!-- Form Name -->
<center><legend>Ajouter une Spécialité</legend></center>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="USERNAME">Nom de spécilité</label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="MAILID">departement</label>  
  <div class="col-md-4">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="VILLAGENAME">details</label>  
  <div class="col-md-4">
