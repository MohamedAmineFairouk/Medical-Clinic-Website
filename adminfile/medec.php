...
<head>
  ...
  <div class="row">
    ...
    <a href="medec2.php?idloc=<?php echo $idloc; ?>" ><button type="button" class="btn btn-success">Calendrier</button></a>
       ...
       <?php
        ...
        if ($result->num_rows > 0) {
           ...
           while($row = $result->fetch_assoc()) {
           	if($row["disponible"]=="1")
           		$lo = "disponible";
           	else $lo = "Non diponible";

 echo "<tr><td>".$row["id_med"]."</td><td>".$row["name_med"]."</td><td> ".$lo."</td></tr> ";
  ...
  <div class="col-md-4">
  <input id="USERNAME" name="id_med" type="text" placeholder="" class="form-control input-md" required>
